...
class _PasscodeScreenState extends State<PasscodeScreen> with SingleTickerProviderStateMixin {
  ...
  Future<bool> _isPasscodeValid(String passcode) async {
    ...
    return passcode == '123456'; // Replace with your actual passcode validation logic
  }
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _isLoading ? 'Verifying passcode...' : 'Enter Passcode',
                              style: TextStyle(
                                fontSize: 22,
                            ...
                            Row(
                              ...
                              children: List.generate(6, (index) {
                                return PasscodeDisplay(
                                  isInput: index < _passcodeController.text.length,
                                );
                              }),
                            ),
